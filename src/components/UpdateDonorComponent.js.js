...
e.preventDefault();
const inputs = document.querySelectorAll('#name, #sex, #age, #bloodGroup, #lastDonation');

inputs.forEach(input => {
  input.value = '';
});

let donor = {name: donorName, sex: sex, age: age, bloodGroup: bloodGroup, lastDonation: lastDonation};
                  ...
                  <div className='card-body'>
                      <form>
                          <div className='form-group'>
                              <label>Name: </label>
                              <input placeholder='name' name='name' id='name' className='form-control'
                                  value={donorName} onChange={changeDonorName}/>
                          </div>
                          <div className='form-group'>
                              <label>Sex: </label>
                              <input placeholder='sex' name='sex' id='sex' className='form-control'
                                  value={sex} onChange={(e) => changeSex(e)}/>
                          </div>
                          <div className='form-group'>
                              <label>Age: </label>
                              <input placeholder='age' name='age' id='age' className='form-control'
                                  value={age} onChange={(e) => changeAge(e)}/>
                          </div>
                          <div className='form-group'>
                              <label>Blood Group: </label>
                              <select required style={{width: 170, marginLeft: 20}} placeholder="Enter blood group" onChange={changeBloodgroup}>
                          ...
                          <div className='form-group'>
                              ...
                              <input type="date" placeholder='Last Donation' name='lastDonation' id='lastDonation' className='form-control'
                                  value={lastDonation.substring(0,10)} onChange={changeLastDonation}/>
                          </div>

                          <button className='btn btn-success'onClick={updateDonor} id='btn'>Update</button>
